...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Configurations/p_Are you sure'), 'Are you sure?')

WebUI.click(findTestObject('Object Repository/Page_Configurations/button_No, Cancel'))
