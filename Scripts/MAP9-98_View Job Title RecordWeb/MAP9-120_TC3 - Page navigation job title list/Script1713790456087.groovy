...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/i_chevron_right'), 'chevron_right')

WebUI.click(findTestObject('Object Repository/Page_Job/i_chevron_right'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/i_chevron_left'), 'chevron_left')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/li_Rows per page'), 'Rows per page')

WebUI.click(findTestObject('Object Repository/Page_Job/input__select-dropdown active'))

WebUI.click(findTestObject('Object Repository/Page_Job/span_10'))
