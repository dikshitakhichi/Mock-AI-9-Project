...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/i_arrow_upward'), 'arrow_upward')

WebUI.click(findTestObject('Object Repository/Page_Job/i_arrow_upward'))

WebUI.click(findTestObject('Object Repository/Page_Job/i_arrow_downward'))
