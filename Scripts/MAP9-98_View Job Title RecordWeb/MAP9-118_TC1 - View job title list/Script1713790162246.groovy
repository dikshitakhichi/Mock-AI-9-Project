...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/th_Job Title   arrow_upward'), 'Job Title arrow_upward')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/th_Job Description'), 'Job Description')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/td_ohrm_edit'), 'ohrm_edit')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/i_add'), 'add')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/a_Delete Selected'), 'Delete Selected')
