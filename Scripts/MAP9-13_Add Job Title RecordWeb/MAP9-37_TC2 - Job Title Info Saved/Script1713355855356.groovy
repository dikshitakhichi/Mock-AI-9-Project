...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Employee Management/a_Dashboard'), 'Dashboard')
...
WebUI.click(findTestObject('Object Repository/Page_Job/div_Add Job Title   Job TitleJob Title  Alr_3ce5ab'))
