...
WebUI.click(findTestObject('Object Repository/Page_Job/input__jobTitleName'))

WebUI.click(findTestObject('Object Repository/Page_Job/button_Save'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/span_Required'), 'Required')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/small_Required'), '* Required')
