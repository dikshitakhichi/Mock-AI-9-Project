...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Login Main'))
...
WebUI.click(findTestObject('Object Repository/Page_Job/div_Job TitleJob Title'))

WebUI.setText(findTestObject('Object Repository/Page_Job/input__jobTitleName'), '')

WebUI.setText(findTestObject('Object Repository/Page_Job/textarea_Job Description_jobDescription'), '')
