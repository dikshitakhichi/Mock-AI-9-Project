...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/input__jobTitleName'), '')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/textarea_Job Description_jobDescription'), '')
