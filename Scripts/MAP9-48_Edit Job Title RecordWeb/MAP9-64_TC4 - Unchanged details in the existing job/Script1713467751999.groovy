...
WebUI.click(findTestObject('Object Repository/Page_Configurations/a_pathfill64728cHR Administration'))
...
WebUI.click(findTestObject('Object Repository/Page_Job/i_arrow_upward'))

WebUI.click(findTestObject('Object Repository/Page_Job/td_ohrm_edit'))

WebUI.setText(findTestObject('Object Repository/Page_Job/input__jobTitleName'), 'Software Engineer111')

WebUI.setText(findTestObject('Object Repository/Page_Job/textarea_Job Description_jobDescription'), 'res')

WebUI.click(findTestObject('Page_Job/Page_Job/button_CancelEditJob'))
