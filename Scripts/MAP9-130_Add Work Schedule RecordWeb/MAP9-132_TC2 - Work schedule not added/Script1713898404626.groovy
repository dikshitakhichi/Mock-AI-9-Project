...
WebUI.setText(findTestObject('Object Repository/Page_Configurations/input_Schedule Name_schedule_name'), 'new test')

WebUI.click(findTestObject('Object Repository/Page_Configurations/div_Working Day'))
