...
WebUI.setText(findTestObject('Object Repository/Page_Configurations/input_Schedule Name_schedule_name'), randomText)

WebUI.click(findTestObject('Page_Configurations/div_Working Day'))

WebUI.click(findTestObject('Page_Configurations/Non-working day'))

WebUI.click(findTestObject('Object Repository/Page_Configurations/icon - shift in'))

WebUI.sendKeys(findTestObject('Page_Configurations/input'), Keys.chord(Keys.CONTROL, 'a') + Keys.DELETE)

WebUI.setText(findTestObject('Object Repository/Page_Configurations/input'), '8')

WebUI.click(findTestObject('Page_Configurations/button_Save'))
