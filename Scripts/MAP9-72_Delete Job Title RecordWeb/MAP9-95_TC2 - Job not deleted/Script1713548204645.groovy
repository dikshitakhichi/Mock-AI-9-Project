...
WebUI.setText(findTestObject('Object Repository/Page_Job/input__jobTitleName'), randomText)

WebUI.setText(findTestObject('Object Repository/Page_Job/textarea_Job Description_jobDescription'), randomText)

WebUI.setText(findTestObject('Object Repository/Page_Job/textarea_Note_note'), 'test')
...
WebUI.click(findTestObject('Object Repository/Page_Job/a_Delete Selected'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/h5_Are you sure'), 'Are you sure?')

WebUI.click(findTestObject('Object Repository/Page_Job/button_No, Cancel'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/span_BA'), randomText)
