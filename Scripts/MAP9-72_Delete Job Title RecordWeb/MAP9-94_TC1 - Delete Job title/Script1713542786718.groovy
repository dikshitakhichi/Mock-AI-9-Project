...
WebUI.setText(findTestObject('Object Repository/Page_Job/textarea_Job Description_jobDescription'), 'dev')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Job/td_Test Software Dev'), randomText)
...
WebUI.click(findTestObject('Page_Job/a_Delete Selected'), FailureHandling.STOP_ON_FAILURE)
